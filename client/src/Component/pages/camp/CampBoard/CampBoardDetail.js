      ...
      <h1 id='campdetailTitle'>상세보기</h1>
            ...
            <img src={tentIMG} alt='텐트' id='DetailIMG'></img>
              <div>
                ...
                <p id='campdetaillocation'>위치 | {boardData.camp_location}{boardData.camp_address}</p>
                <p ><span id='campdetail'>전화번호  |</span> {boardData.camp_phone}</p>
                
                <p ><span id='campdetail'>성인  |</span> {boardData.camp_adult}명</p>
                <p ><span id='campdetail'>아동  |</span> {boardData.camp_child}명</p>
                <p ><span id='campdetail'>가격  |</span> {boardData.camp_price}원</p>
                <p ><span id='campdetail'>시설  |</span>{boardData.camp_facility}</p>
                
              
              <div>
                <Button id='detailReservationButton' variant="primary"  onClick={reserveMove}className="mt-3">
                  예약하기
                </Button>
            ...
            { isCurrentUser &&(
                <button onClick={handleDelete} id='detailReservationButton2' variant="primary">삭제</button>
            )}
            </div>
